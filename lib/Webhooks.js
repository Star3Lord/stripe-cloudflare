...
const Webhook = {
  ...
  generateTestHeaderString: function (opts) {
    ...
    opts.cryptoProvider = opts.cryptoProvider || getSubtleCryptoProvider();
    opts.signature =
      opts.signature ||
...
const signature = {
  ...
  verifyHeader(
    ...
    cryptoProvider = cryptoProvider || getSubtleCryptoProvider();
...
let webhooksSubtleCryptoProviderInstance = null;
/**
...
function getSubtleCryptoProvider() {
  if (!webhooksSubtleCryptoProviderInstance) {
    const SubtleCryptoProvider = require('./crypto/SubtleCryptoProvider');
    webhooksSubtleCryptoProviderInstance = new SubtleCryptoProvider();
  }
  return webhooksSubtleCryptoProviderInstance;
}
